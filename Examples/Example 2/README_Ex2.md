...
|:--:| 
| *Fig. 6. Phase-shift map of the gas target using a Gaussian blur of a) 10 pixels and b) 20 pixels.* |
...
|:--:| 
| *Fig. 7. Phase-shift map of the gas target using a Gaussian blur of a) 10 pixels and b) 20 pixels.* |
